                ...
                @foreach($users as $u)
                    <tr>
                        ...
                        <td>
                            ...
                            <a data-toggle="modal" data-target="#e{{$u->id}}" href="#" class="btn btn-sm btn-outline-info"><i class="fas fa-user-edit"></i></a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                <h5 class="modal-title">Change Role for "<b>{{$u->name}}</b>"</h5>
                            ...
                            <a data-toggle="modal" data-target="#d{{$u->id}}" href="#" class="btn btn-sm btn-outline-danger"><i class="fas fa-times-circle"></i></a>
                            {{-- Start delete modal--}}
