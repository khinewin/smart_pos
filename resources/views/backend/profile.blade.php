       ...
       <div class="col-sm-8">
           <div class="card shadow">
               ...
               <div class="col-4">
                   ...
                   @else {{url('images/user.png')}} @endif">

               </div>
               <div class="card-body">
                   <p>
                       <i class="fas fa-user"></i> Username: <span class="text-bold ">{{Auth::User()->name}}</span>
                   </p>
                   <p>
                   ...
                   <p>
                       <i class="fas fa-calendar-day"></i> Member Since : <span class="text-bold">{{Auth::User()->created_at->diffForHumans()}}</span>
                   </p>
               </div>
           </div>
       </div>
